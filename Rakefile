...
require File.join(File.dirname(__FILE__), 'lib/rails_sql_views-az', 'version')

PKG_BUILD       = ENV['PKG_BUILD'] ? '.' + ENV['PKG_BUILD'] : ''
PKG_NAME        = 'rails_sql_views-az'
...
task :pdoc => [:rdoc] do 
  Rake::SshDirPublisher.new("aeden@rubyforge.org", "/var/www/gforge-projects/activewarehouse/rails_sql_views-az/rdoc", "rdoc").upload
end
